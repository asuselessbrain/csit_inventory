...
router.get('/proposal-report', auth(UserRole.STUDENT), ProjectThesisController.generateStudentProposalReport)
router.get('/proposal-report-teacher', auth(UserRole.TEACHER), ProjectThesisController.generateTeacherProposalReport)
router.get('/project-thesis-report-admin', auth(UserRole.ADMIN), ProjectThesisController.generateProjectThesisReportForAdmin)
