            ...
            <Card key={task.id} className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div
                    className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(task.status)}`}
                  >
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span
                    className={`font-medium ${isOverdue(task.dueDate) ? "text-red-600 dark:text-red-400" : "text-gray-900 dark:text-white"}`}
                  >
