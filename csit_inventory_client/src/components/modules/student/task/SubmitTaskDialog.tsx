    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                toast.error(res.errorMessage || "Failed to submit task");
            }
        } catch (error) {
            toast.error("Failed to upload file or submit task");
        } finally {
            setLoading(false);
        }
    };
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <DialogFooter className="flex gap-2 sm:justify-end">
                        ...
                        <Button type="submit" disabled={loading || (!selectedFile && !fileUrl)}>
